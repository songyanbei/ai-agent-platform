...
def build_plan_declared() -> Dict[str, Any]:
    """
    构建规划声明消息
    ...
    return build_java_message(
        ...
        messages=StageDefinition.get_all_stages()
    )
